...
def main():
    ...
    body = ["<title>Real-Only Arms, Replan Interval</title>",
            ...
            "<h3>Left gate</h3>",
            section("left", ["pin APC 50=armrealonly_left", "pin APC 25=armrealonly_apc25_left", "pi0 APC 50=armscrreal_left", "pi0 APC 25=armscrreal_apc25_left"], None, "vL"),
            "<h3>Right gate</h3>",
            section("right", ["pin APC 50=armrealonly_right", "pin APC 25=armrealonly_apc25_right", "pi0 APC 50=armscrreal_right", "pi0 APC 25=armscrreal_apc25_right"], None, "vR")]
