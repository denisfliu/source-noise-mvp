...
camera lands the point where the ray meets the height plane, which can sit tens of cm off
what you are visually aiming at. Grey = the unguided flights (where it goes wrong), blue/yellow = judge
