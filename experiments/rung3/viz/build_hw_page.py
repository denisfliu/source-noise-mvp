...
for title, tag, side, apc, ref, elem in [
    ...
    ("pi0 on the 100 real demos only (baseline_real), left gate, 2026-09-18 (5 flights, apc 50)", "baselinereal_left", "left", 50, ref_l, "v_brl"),
    ("pi0 on the 100 real demos only (baseline_real), right gate, 2026-09-18 (5 flights, apc 50)", "baselinereal_right", "right", 50, ref_r, "v_brr"),
    ("Mixed-data pin without swap (gmsig3), left gate, 2026-09-18 (5 flights, apc 50; all five crashed by eye)", "gmsig3_left", "left", 50, ref_l, "v_gl"),
