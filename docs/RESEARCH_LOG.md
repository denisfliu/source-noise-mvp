...
scripts/run_scrreal_apc25.sh, same protocol; page viz/realonly_apc25.html now carries both arms.
  ...
  transit held (8-9/10) at the shorter horizon; the plain flow's did not. (3) The two real-only arms end
  differently: the plain pi0 descends to z 1.14-1.27 after the crossing and so drops INTO the goal box (that is
