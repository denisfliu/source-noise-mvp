...
TRAINEXTRA="SNMVP_DATA_DIR=data_gate_synth2 SNMVP_HEAD_DETACH=0 SNMVP_HEAD_LAM=0.3 SNMVP_HEAD_GMM=1 SNMVP_PIN_NOISE=1.5 SNMVP_PIN_NOISE_RAND=1 SNMVP_PIN_NOISE_COND=1"
CK=/home/dfliu/code/openpi-snmvp/checkpoints/pi0_gate2/gate_pin_joint_$NAME/4999
PORT=9002
...
rm -rf /home/dfliu/code/openpi-snmvp/checkpoints/pi0_gate2/gate_pin_joint_$NAME/*/train_state
