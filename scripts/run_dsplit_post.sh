...
CK=/home/dfliu/code/openpi-snmvp/checkpoints/pi0_gate3/gate_pin_joint_$NAME/5499
PORT=9016
...
{ echo "== arm $NAME  steps=5000 decay=1000000 U=$(basename $U) sigma-conditioned PIN_NOISE=1.5 RAND+COND seed=42 dsplit(A:synth+head B:real flow-only)"
