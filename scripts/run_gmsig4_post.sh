...
TRAINEXTRA="SNMVP_DATA_DIR=data_gate_synth3 SNMVP_HEAD_DETACH=0 SNMVP_HEAD_LAM=0.3 SNMVP_HEAD_GMM=1 SNMVP_PIN_NOISE=1.5 SNMVP_PIN_NOISE_RAND=1 SNMVP_PIN_NOISE_COND=1 SNMVP_HEAD_COND_DROP=0.4,0.15,0.1"
