...
PORT=9171
OUT=$RUN/nudge3_scores.txt
rm -f $RUN/nudge3.done $OUT
cd $RD
...
for k in $(seq 1 240); do [ -f $RUN/nudge.done ] && break; sleep 30; done
cell ng_3t_coarse  pin     nudge_cmpl_3t_coarse.json
cell ng_3t_h50     pin     nudge_cmpl_3t_h50.json
cell ng_3t_all     pin     nudge_cmpl_3t_all.json
cell ng_sde03_3t   sde:0.3 nudge_cmpl_3t_all.json
echo DONE > $RUN/nudge3.done
